...
RUN mkdir Consumos
RUN mkdir OMIE_Data
RUN mkdir ERedes_consumption_profiles
RUN mkdir ERedes_loss_profiles
RUN mkdir Logs
RUN mkdir EOT
...
COPY ./ERedes_consumption_profiles /app/ERedes_consumption_profiles
COPY ./ERedes_loss_profiles /app/ERedes_loss_profiles
...
# change the permission for the Nginx web folder
