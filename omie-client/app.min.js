...
c.consumo.Vazio,document.getElementById("analysis-contador-cheio").value=c.consumo.Cheias,document.getElementById("analysis-contador-ponta").value=c.consumo.Ponta);priceTrackerApp.setupSliderForData(priceChartAnalysis,c.records);hideAlert()}catch(b){showAlert("Erro no processamento do ficheiro. Verifique se est\u00e1 a usar o ficheiro correto..."),console.error("Error uploading file:",b)}}
function updateDropDownProviderTitle(a,b){a.preventDefault();document.getElementById("analisys-provider").innerHTML=b.innerHTML}function updateDropDownDivisor(a,b){a.preventDefault();document.getElementById("analisys-divisor").innerHTML=b.innerHTML;CONFIG.divisor="Auto"==b.innerHTML?0:b.innerHTML}function showAlert(a){const b=document.getElementById("processingAlert");b.querySelector("strong").textContent=a;b.style.display="block";new bootstrap.Alert(b)}
